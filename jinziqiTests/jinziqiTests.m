...
-(void)testInfoBoard
{
    ...
    [chessboardSense showInfoBoard:@"win"];
    XCTAssertTrue([chessboardSense.infoBoard.message isEqualToString:@"win"], @"");
    XCTAssertFalse([chessboardSense.infoBoard.message isEqualToString:@"w"], @"");
}
-(void)testChessboardClean
{
    SnChessboradViewController *chessboardSense = [[SnChessboradViewController alloc]initChessBoard];
